...
<div class="py-4 d-flex col-lg-9 gap-5 w-100">
    ...
    <div class="col-lg-8 d-flex flex-wrap gap-5">
        ...
        <a href="{{asset(Storage::url($doc->ruta))}}" class=" card text-decoration-none text-success d-flex flex-column align-items-center text-start" style="width: 15rem;">
                ...
                <div class="card-body d-flex justify-center m-auto text-center w-100">
                  <p class="card-text w-100 text-center" >{{$doc->nombre}}</p>
                </div>
        </a>
        @endforeach
    </div>
